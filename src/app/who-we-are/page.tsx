      ...
      <main id="main-content">
        ...
        <section className="border-y border-white/[.07] bg-navy-900/35 py-24 sm:py-28 lg:py-36">
          <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <div className="mb-10 flex flex-col justify-between gap-6 sm:mb-14 lg:flex-row lg:items-end"><div><span className="text-[11px] font-bold uppercase tracking-[.24em] text-cyan-accent">What guides us</span><h2 className="mt-5 max-w-[12ch] font-display text-[clamp(2.5rem,5vw,4.5rem)] font-bold leading-[.95] tracking-[-.045em] text-white">Built for certainty.</h2></div><p className="max-w-md text-base leading-7 text-silver-300/65">The detail matters. So does the way it feels to work with the people handling it.</p></div>
